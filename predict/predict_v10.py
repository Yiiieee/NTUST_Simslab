...
def predict_live_camera(camera_index, model, transform, class_names, clip_len=16, device="cpu"):
    ...
    detect_needed = 2  # naikkan ke 3/4 kalau alert terlalu cepat hilang
    ...
    while True:
        ...
        if len(frame_buffer) == clip_len:
            ...
            # ==============================================
            # ALERT LOGIC
            # Assemble1 done -> alert Assemble2
            # Assemble2 start -> hide Assemble2 alert
            # Assemble2 done -> alert Assemble3
            # Assemble3 start -> hide Assemble3 alert
            # ==============================================

            # Setelah Assemble1 selesai, munculkan alert untuk Assemble2
            ...
            # Setelah Assemble2 selesai, munculkan alert untuk Assemble3
            ...
            # Deteksi Assemble3 mulai
            if last_pred_class == "Assemble3" and last_conf >= conf_threshold:
...
def main():
    ...
    predict_live_camera(
        #camera_index="/home/simslab/Desktop/api/predict/test/camera1_20260430_205926.mp4",
        camera_index=0,
        model=model,
        transform=transform,
