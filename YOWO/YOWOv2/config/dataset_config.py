...
dataset_config = {
    ...
    'my_pipeline': {
        # --- 基礎資料設定 ---
        'data_root': '/home/simslab/Desktop/api/Ziv/YOWO/pipeline_data/',
        'train_list': 'trainlist.txt',
        'test_list': 'testlist.txt',
        'gt_folder': '/home/simslab/Desktop/api/Ziv/YOWO/pipeline_data/annotations/train/',
        'multi_hot': False, 
        'valid_num_classes': 7,
        'label_map': (
            {'name': 'waiting',   'id': 0},
        ...
        # --- 核心新增：優化器與訓練策略 (解決 KeyError: 'optimizer') ---
        'optimizer': 'adamw',       
        'momentum': 0.9,            
        'weight_decay': 0.0005,     
        'lr_epoch': [20, 30, 40],   
        ...
        # --- 核心新增：暖身期設定 (解決 KeyError: 'warmup') ---
        'warmup': 'linear',         # 暖身方式：線性增加學習率
        'warmup_epoch': 3,
        'warmup_factor': 0.001,
        'wp_iter': 500,
        # --- 其他影像設定 ---
